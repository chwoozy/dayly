...
class _ProfileState extends State<Profile> {
  ...
  Widget build(BuildContext context) {
    ...
    final _databaseService = DatabaseService(uid: _userData.uid);
            ...
            child: Stack(
              children: <Widget>[
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.vertical(bottom: Radius.circular(49)),
                ),
              ),
              Container(
                height: 200,
              ...
              child: RoundedButton(
                ...
                press: () async {
                  ...
                  if (_formKey.currentState.validate()) {
                    ...
                    _databaseService.updateUserData(_userData.name, _email == '' ? _userData.email : _email, _userData.type, _imageUrl).whenComplete(() async {
